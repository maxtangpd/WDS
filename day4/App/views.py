...
@blue.route("/sendrequest/", methods = ["GET", "POST", "PUT", "DELETE", "PATCH"])
def send_request():
...
def get_response():
    ...
    #response = make_response("<h2>班主任说</h2>")
...
def user_register2():
    ...
    return render_template('user/user_register2.html', title="注册页面2", users = users)
